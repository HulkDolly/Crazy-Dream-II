...
data merge entity @s {Rotation:[90F,0F],Tags:["obj.chear"],item:{id:"minecraft:potion",count:1,components:{"minecraft:custom_model_data":11,"minecraft:potion_contents":{custom_color:0}}}}
...
scoreboard players operation *gametime main_score %= *80 const
