...
data merge entity @s {Rotation:[0F,0F],Tags:["obj.gl1_start"],item:{id:"minecraft:potion",count:1,components:{"minecraft:custom_model_data":5,"minecraft:potion_contents":{custom_color:0}}}}
...
scoreboard players operation *gametime main_score %= *600 const
